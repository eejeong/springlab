        ...
        <table class="table table-hover">
          ...
          <c:forEach var="obj" items="${allcart}">
            <tr>
              ...
              <td>${obj.item_id}</td>
              <td>${obj.item_name}</td>
              <td><fmt:formatNumber value="${obj.item_price}" type="currency" currencyCode="KRW" pattern="###,###원" /></td>
              <td>${obj.cnt}</td>
              <td><fmt:formatNumber value="${obj.cnt * obj.item_price}" type="currency" currencyCode="KRW" pattern="###,###원" /></td>
