...
public class WeatherUtil {
    public static String getWeather1(String loc) throws Exception{
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=KN4l1nkw%2BO9%2BJmAlJmi2tdij%2F6RPsXZhsJ9OHMJiB%2BFXZM%2FePFh58Y%2FHQx9SSMsv%2FhpBqnOMsHQAh10s6BpnwA%3D%3D"); /*Service Key*/
        ...
        conn.disconnect();
        // JSON -> java Object
        // sb.toString()이 parser 통해 JSONObject 가 됨
...
//        "item": [
//        {
//        "wfSv": "○ (하늘상태) 이번 예보기간에는 구름많은 날이 많겠습니다.  \n○ (기온) 이번 예보기간 아침 기온은 10~19도, 낮 기온은 19~29도로 평년(최저기온 11~15도, 최고기온 21~27도)과 비슷하거나 조금 높겠습니다.\n○ (주말전망) 13일(토)~14일(일) 전국이 가끔 구름많겠습니다. 아침 기온은 10~14도, 낮 기온은 19~25도가 되겠습니다.\n\n* 13일(토)~14일(일)은 우리나라 주변 기압계의 흐름에 따라 예보가 변경될 가능성이 있으니, 앞으로 발표되는 최신 예보를 참고하기 바랍니다."
//        }
//        ]
//        },
//        "pageNo": 1,
